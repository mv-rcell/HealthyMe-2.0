...
const FeatureCard = ({ icon, title, description, index, linkTo, image }: any) => (
  <Link
    to={linkTo}
    className={cn(
...
const features = [
  
  {
    ...
    description:
      "Secure video and in-app messaging to consult your provider from anywhere, with prescription sharing and treatment plans.",
  ...
  },
  {
    ...
    description:
      "Search by service, filter by location or ratings, and view detailed profiles to find the right fit for your needs.",
  ...
  },
  {
    ...
    description:
      "Access bundled health services like physiotherapy, nutrition, and mental care — with reports and progress tracking.",
  ...
  },
  {
    ...
    description:
      "Sync data from your wearables to view trends in sleep, steps, and mood — plus personalized alerts and insights.",
  ...
  },
  {
    ...
    description:
      "Request therapists or caregivers to your doorstep and track their ETA — ideal for post-op recovery or elder care.",
  ...
  },
  {
    ...
    description:
      "Join 21-day programs for detox, stress relief, or movement — complete goals and compete on leaderboards.",
  ...
  },
  {
    ...
    description:
      "Explore verified feedback from real users to help choose the right professionals based on real experiences.",
  ...
  },
  {
    ...
    description:
      "Book lab tests and screening services with digital results and automated follow-up scheduling.",
      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <FeatureCard key={index} {...feature} index={index} image={[index]} />
          ))}
        </div>
