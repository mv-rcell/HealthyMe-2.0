    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">Health User</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          {/* Health Summary Card - Like the bank card */}
          <Card className="bg-gradient-to-r from-red-600 to-red-800 text-white rounded-2xl mb-6 overflow-hidden relative">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <div className="text-center cursor-pointer" onClick={() => navigate('/functional-features')}>
                  <div className="w-12 h-12 mx-auto mb-2 rounded-xl bg-red-50 flex items-center justify-center">
